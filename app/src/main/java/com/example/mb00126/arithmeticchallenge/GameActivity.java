...
public class GameActivity extends AppCompatActivity {
    ...
    private void setViewObjects(){
        ...
        mQuestionText = findViewById(R.id.textViewQuestion);
        mProgressBar = findViewById(R.id.progressBar);
        mScoreText = findViewById(R.id.textViewScore);
        mHighScoreText = findViewById(R.id.textViewHighScore);
        mChoice[0] = findViewById(R.id.choice0);
        mChoice[1] = findViewById(R.id.choice1);
        mChoice[2] = findViewById(R.id.choice2);
